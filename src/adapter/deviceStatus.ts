import type { IDeviceStatusData, IDeviceStatusResponse } from "innoxel-soap";
import type { Innoxel } from "../main";

type IndexableDeviceStatusResponse = IDeviceStatusResponse & {
  [key: string]: IDeviceStatusData | string;
};

export async function createDeviceStatusStates(
  adapter: Innoxel,
...
function getCommon(
  dataObj: IndexableDeviceStatusResponse,
  key: string,
...
export async function updateDeviceStatusStates(
  adapter: Innoxel,
  data: IDeviceStatusResponse,
): Promise<void> {
